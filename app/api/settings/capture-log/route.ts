...
const QuerySchema = z.object({
  ...
  status: z.enum(['captured', 'skipped', 'excluded', 'all']).default('all'),
  source: z.enum(['notion', 'slack', 'all']).default('all'),
})
...
export async function GET(req: Request) {
  try {
    ...
    console.error('[settings/capture-log GET]', err)
